...
function SelectTrigger({ className, size = "default", children, ...props }) {
  return (
    <SelectPrimitive.Trigger
      ...
      data-size={size}
      className={cn(
        "flex w-full h-[48px] items-center justify-between rounded-md border bg-primary border-white/10 px-4 py-5 text-base text-white/60 placeholder:text-white/10 focus:border-accent outline-none",
        className
      )}
      {...props}
    >
